...
function RequestFormController($scope, $http, $stateParams, $cookies, $state) {
    ...
    $scope.categories_ENGLISH = [
        ...
        {"name" : "Bedding Items/Clothes", "id": "4", "value" : "CLOTHES"},
        {"name" : "Security", "id": "5", "value" : "SECURITY"},
    ...
    $scope.categories_TAMIL = [
        ...
        {"name" : "Locate Missing Person | காணாமல் போனவர்கள் கண்டறிதல்", "id": "2", "value" : "MISSING"},
        {"name" : "Medical | மருத்துவ உதவி", "id": "3", "value" : "MEDICAL"},
        {"name" : "Bedding Items/Clothes | படுக்கைப் பொருட்கள்/ஆடைகள்", "id": "4", "value" : "CLOTHES"},
        {"name" : "Security | பாதுகாப்பு", "id": "5", "value" : "SECURITY"},
        {"name" : "Food Items| உணவுப் பொருட்கள்", "id": "6", "value" : "FOOD"},
        {"name" : "Warning | எச்சரிக்கை", "id": "7", "value" : "WARNING"},
        {"name" : "School Items | பாடசாலை உபகரணங்கள்", "id": "8", "value" : "SCHOOL"},
        {"name" : "Search & Rescue Items | தேடுதல் மற்றும் மீட்பு தொடர்பான பொருட்கள்", "id": "9", "value" : "SEARCH"},
        {"name" : "Shelter | தங்குமிடம்", "id": "10", "value" : "SHELTER"},
    ...
    $scope.categories_SINHALA = [
        ...
        {"name" : "Bedding Items/Clothes | නිදන ද්‍රව්‍ය/ඇඳුම්", "id": "4", "value" : "CLOTHES"},
        {"name" : "Security | ආරක්ෂක සේවා", "id": "5", "value" : "SECURITY"},
